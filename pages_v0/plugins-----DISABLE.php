            ...
            <form id="pluginUploadForm" enctype="multipart/form-data" onsubmit="return false;">
                <div class="row g-2">
                    <div class="col-md-8">
                        ...
                        <div class="form-text text-muted"><span style="color: #ffffff;">Se permiten <code>.dll</code> (mods) y <code>.db</code> (datos).</span></div>
                    </div>
    ...
    <div class="table-responsive">
        <table class="table table-dark table-striped align-middle text-center">
            ...
            <?php if (empty($pluginDBs)): ?>
                <tr><td colspan="3">📭 No hay archivos .db.</td></tr>
